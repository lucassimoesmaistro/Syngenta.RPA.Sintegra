...
namespace Syngenta.RPA.Sintegra.Application.Tests
{
    ...
    public class ExcelHandlerTests
    {
        ...
        [Fact(DisplayName = "Remove Excel File From Folder")]
        [Trait("Category", "Excel - Read Excel File")]
        public void ShouldRemoveExcelFileFromFolder()
        {
            // Arrange            
            string excelPath = _applicationTestsFixture.GetConfiguration("FilesPath:NewFiles");
            string fileName = "CustomesDataTests.xlsx";
            // Act
            //var excel = ExcelExtensions.Read<CustomersColletion>(excelPath, fileName, "Base");
